          ...
          <div class="modal-content">
            <form action="Function/Creat.jsp" method="get">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">新增類型</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex justify-content-center">
                        <label class="text-nowrap fs-4" for="COb1">教室類型代碼：</label>
                        <input class="form-control width-25 " id="COb1" type="text"   name="Ob1"  pattern="[0-9A-Z]" required>
                    </div>
                    <div class="d-flex justify-content-center">
                        <label class="text-nowrap fs-4" for="COb2">教室類型名稱：</label>
          ...
          <div class="modal-content">
            <form action="Function/Delete.jsp" method="get">
                ...
                <div class="modal-body">
                	<div class="d-flex justify-content-center">
                        <label class="text-nowrap fs-4" for="Ob0">資料表位置：</label>
                        <input class="form-control width-25 " id="DOb0" type="text"  readonly="true" name="Ob0" value="Classroom_Type_Code" >
                    </div>
                    <div class="d-flex justify-content-center">
                        <label class="text-nowrap fs-4" for="Ob1">主鍵欄位名稱：</label>
                        <input class="form-control width-25 " id="DOb1" type="text"  readonly="true" name="Ob1" value="Type_Code" >
                    </div>
                    <div class="d-flex justify-content-center">
                        <label class="text-nowrap fs-4" for="Ob2">類型代碼：</label>
