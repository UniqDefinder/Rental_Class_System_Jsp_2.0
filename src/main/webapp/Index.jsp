...
<head>
    ...
    <%
    	session.setAttribute("Access_Type",null);
	    ...
	    if(request.getParameter("Account") !=null &&request.getParameter("Password") !=null){
			...
			if(rs.next()){
				...
				int i = Integer.parseInt(rs.getString("Identity"));
				...
				case 1:
					...
					response.sendRedirect("User_Pages/User_Index.jsp");
					break;
				...
				case 2:
					...
					session.setAttribute("Access_Id",request.getParameter("Account"));
					session.setMaxInactiveInterval(10*60);
					response.sendRedirect("Inspector_Pages/Inspector_Index.jsp");
					break;
